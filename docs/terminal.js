...
(function () {
  ...
  // Universo de acoes/cripto pesquisavel - agora em ticker-universe.js
  // (carregado antes deste script), reaproveitado tambem por
  // exposicao.html. var local so pra nao reescrever cada uso abaixo.
