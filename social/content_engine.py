...
TEXTO_ANALISE_EDITORIAL_PROMPT = (
    ...
    "Quando mais de um fato/manchete for fornecido, nunca invente relacao "
    "causal entre eles so porque apareceram juntos - podem ser sobre "
    "empresas, paises ou temas totalmente independentes. So afirme que um "
    "acontecimento influenciou o outro (ou o mercado) se isso estiver "
    "explicito nos dados fornecidos. Prefira uma resposta mais generica e "
    "honesta a forcar uma narrativa conectada que os dados nao sustentam."
)
...
def gerar_conteudo_closing(dados, entries_today):
    ...
    prompt = (
        ...
        "ATENCAO: FATO PRINCIPAL DO DIA e MAIORES DESTAQUES (alta/baixa) sao "
        "coletados de formas INDEPENDENTES e podem nao ter NENHUMA relacao entre "
        "si (podem ser sobre empresas ou setores totalmente diferentes). NUNCA "
        "invente ou sugira que o fato principal foi a causa da maior alta/baixa "
        "(ou vice-versa) a menos que isso esteja explicito em ambos os textos.\n\n"
        ...
        "isso significa para o investidor - combine o FATO com sua INTERPRETACAO "
        "numa explicacao so (nunca combine o destaque de alta/baixa com o fato "
        "principal como se um explicasse o outro, salvo se isso for explicito); "
